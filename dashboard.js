...
const presentations = [
        ...
        { id: 46, title: "סימולטור קוביות תלת-מימדי", category: "סימולציות", driveUrl: "", siteUrl: "https://itaibental.github.io/3dboxsimulator/index.html", description: "בניית מבנים מקוביות וסיבוב 360° לפיתוח קריאה במרחב תלת-מימדי.", info: "• בניית שכבות: המורה בונה מבנה תלת-מימדי שכבה אחר שכבה, עד לגובה בלתי מוגבל.\n• סיבוב 360°: גרירת המודל לכל כיוון לצפייה מכל זווית אפשרית.\n• צביעת קומות: כל קומה ניתנת לצביעה בצבע שונה לצורך הדגשה ויזואלית והוראה ברורה.\n• קריאה במרחב: פיתוח יכולת הדמיה מרחבית – זיהוי מבנים ממבטים עליון, קדמי ונסתר.\n• הדגמה פרונטלית: כלי אידיאלי לשיעורים במתמטיקה ובגיאומטריה תלת-מימדית." }
    ];
