...
const presentations = [
        ...
        { id: 49, title: "Affinity Studio", category: "עיצוב ויצירה", driveUrl: "", siteUrl: "https://www.affinity.studio/", description: "חבילת תוכנות עיצוב מקצועיות (Photo, Designer, Publisher) מבית Canva – חינמיות לחלוטין להורדה למחשב.", info: "• מבית Canva: Affinity נרכשה על ידי Canva ב-2024, ומאז כל התוכנות ניתנות להורדה חינם לחלוטין.\n• Affinity Photo: עריכת תמונות מקצועית עם שכבות, מסכות, פילטרים ותיקוני צבע ברמת פוטושופ.\n• Affinity Designer: תוכנת וקטורים מתקדמת ליצירת לוגואים, איורים ועיצובים גרפיים.\n• Affinity Publisher: עיצוב פרסומים, ספרים, עיתונים ומגזינים בממשק מקצועי.\n• חלופה מקצועית: חלופה אמיתית לחבילת Adobe (Photoshop, Illustrator, InDesign) ללא מנוי חודשי.\n• לימוד עיצוב מקצועי: כלי אידיאלי לתלמידים הלומדים עיצוב גרפי ברמה מתקדמת." },
        { id: 47, title: "Suno", category: "עיצוב ויצירה", driveUrl: "", siteUrl: "https://suno.com/", description: "יצירת שירים מקוריים באיכות סטודיו בעזרת בינה מלאכותית – מדברים, מקבלים מוזיקה.", info: "• יצירת שירים שלמים: הקלידו תיאור קצר (Prompt) וה-AI ייצור שיר שלם הכולל מנגינה, קצב ושירה.\n• סגנונות מגוונים: ניתן לבחור ז'אנר מוזיקלי (פופ, ג'אז, קלאסי, ראפ, רוק ועוד) ולקבל תוצאה מדויקת.\n• כתיבת מילים: הזינו את מילות השיר שלכם (Lyrics) וה-AI ישיר אותן בקול אנושי מרשים.\n• למידה מוזיקלית: תלמידים יכולים ליצור שירים על נושאים שלמדו – היסטוריה, מדעים, שפה.\n• פרויקטים יצירתיים: יצירת ג'ינגלים לפרזנטציות, מוזיקת רקע לסרטונים ותוצרי למידה.\n• שיתוף: כל שיר שנוצר ניתן לשיתוף, הורדה ושימוש מיידי ללא צורך ידע מוזיקלי מוקדם." },
...
window.submitSuggestion = async function() {
    ...
    if (!text) return;
    const btn = document.querySelector('.suggest-submit-btn');
    btn.disabled = true;
    btn.innerText = 'שולח...';
    try {
        if (window.submitSuggestionToFirebase) {
            await window.submitSuggestionToFirebase(text);
        }
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (ta) ta.addEventListener('input', () => {
        document.getElementById('suggestCharCount').innerText = ta.value.length;
    });
});
