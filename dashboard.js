...
const presentations = [
        ...
        { id: 49, title: "Affinity Studio", category: "עיצוב ויצירה", driveUrl: "", siteUrl: "https://www.affinity.studio/", description: "חבילת תוכנות עיצוב מקצועיות (Photo, Designer, Publisher) חינמיות לחלוטין דרך הדפדפן.", info: "• Affinity Photo: עריכת תמונות מקצועית עם שכבות, מסכות, פילטרים ותיקוני צבע ברמת פוטושופ.\n• Affinity Designer: תוכנת וקטורים מתקדמת ליצירת לוגואים, איורים ועיצובים גרפיים.\n• Affinity Publisher: עיצוב פרסומים, ספרים, עיתונים ומגזינים בממשק מקצועי.\n• חינמי לחלוטין: הגרסה המקוונת (V2) זמינה ללא תשלום ומבלי להוריד תוכנה.\n• חלופה מקצועית: חלופה אמיתית לחבילת Adobe (Photoshop, Illustrator, InDesign) ללא מנוי חודשי.\n• לימוד עיצוב מקצועי: כלי אידיאלי לתלמידים הלומדים עיצוב גרפי ברמה מתקדמת." },
